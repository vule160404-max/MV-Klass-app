-- =============================================================================
-- 059 - Attach answer/audio directly from Storage objects
--
-- Fixes race cases where the main exam file and answer/audio file are uploaded
-- at nearly the same time. The trigger now scans Storage objects as well as
-- exam_files rows, so an existing answer object can be attached even if no
-- standalone exam_files row was created for it.
-- =============================================================================
