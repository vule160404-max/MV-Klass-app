-- =============================================================================
-- 023 — Tra cứu thanh toán: cho phép p_student_id + p_parent_phone rỗng (tra tên
-- ở Edge, RPC xác thực theo token + id HS, không bắt buộc số điện thoại trong DB).
-- Chạy trên Supabase SQL Editor sau 022.
-- =============================================================================
